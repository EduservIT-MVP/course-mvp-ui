...
const STATUS_ALIASES = {
  ...
  ppt_plan_generating: WORKFLOW.PPT_PLAN_GENERATING,
  plan_generating: WORKFLOW.PPT_PLAN_GENERATING,
  generating_plan: WORKFLOW.PPT_PLAN_GENERATING,
  ppt_plan_review: WORKFLOW.PPT_PLAN_REVIEW,
  plan_review: WORKFLOW.PPT_PLAN_REVIEW,
  waiting_for_approval: WORKFLOW.PPT_PLAN_REVIEW,
  pending_approval: WORKFLOW.PPT_PLAN_REVIEW,
  ...
  lab_plan_generating: WORKFLOW.LAB_PLAN_GENERATING,
  lab_plan_review: WORKFLOW.LAB_PLAN_REVIEW,
  lab_generating: WORKFLOW.LAB_GENERATING,
  lab_review: WORKFLOW.LAB_REVIEW,
  lab_approved: WORKFLOW.LAB_APPROVED,
  lab_guide_plan_generating: WORKFLOW.LAB_GUIDE_PLAN_GENERATING,
  lab_guide_plan_review: WORKFLOW.LAB_GUIDE_PLAN_REVIEW,
...
export function normalizeCourse(payload) {
  ...
  return {
    ...
    plan: course.pptPlan || course.plan || course.coursePlan,
    pptPlan: course.pptPlan || course.plan || course.coursePlan,
    labPlan: course.labPlan,
    guidePlan: course.guidePlan,
